...
本編を終えたら、`発展課題/` にさらに 6 ステップ続きがあります(一括削除 / 絞り込み / `localStorage` 保存 / 編集 / 並べ替え / コンポーネント分割)。
詳しくは `発展課題/README.md` を見てください。
...
出てきた書き方をもっと詳しく知りたくなったら `GUIDE.md` を見てください。
公式ドキュメント([ja.vuejs.org](https://ja.vuejs.org/guide/introduction.html))の該当箇所を、ステップごとにまとめてあります。
...
- **この書き方をもっと知りたい** → `GUIDE.md`(公式ドキュメントへのリンク集)
